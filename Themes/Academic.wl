...
Begin["System`"];
Unprotect[DarkRed,DarkGreen,DarkBlue,DarkCyan,DarkMagenta,DarkYellow,DarkBrown,DarkOrange,DarkPink,DarkPurple,
Red,Green,Blue,Cyan,Magenta,Yellow,Brown,Orange,Pink,Purple,
LightRed,LightGreen,LightBlue,LightCyan,LightMagenta,LightYellow,LightBrown,LightOrange,LightPink,LightPurple];
{{DarkRed,DarkGreen,DarkBlue,DarkCyan,DarkMagenta,DarkYellow,DarkBrown,DarkOrange,DarkPink,DarkPurple},
{Red,Green,Blue,Cyan,Magenta,Yellow,Brown,Orange,Pink,Purple},
{LightRed,LightGreen,LightBlue,LightCyan,LightMagenta,LightYellow,LightBrown,LightOrange,LightPink,LightPurple}}=
{{RGBColor[0.534081, 0.0853132, 0.16669],RGBColor[0.09, 0.38, 0.12],RGBColor[0.163302, 0.119982, 0.79353],RGBColor[0.13, 0.58, 0.89],RGBColor[0.5450980392156862, 0, 0.5450980392156862],RGBColor[0.68, 0.54, 0.19],RGBColor[0.44, 0.22, 0.08],RGBColor[0.8235294117647058, 0.4117647058823529, 0.11764705882352941`],RGBColor[0.66, 0.08235294117647059, 0.48],RGBColor[0.29411764705882354`, 0, 0.5098039215686274]},
...
ToColor[If[1<=#1<=5,{RGBColor[0.192157, 0.388235, 0.807843],RGBColor[0.790588, 0.201176, 0.],RGBColor[0., 0.596078, 0.109804],RGBColor[1., 0.607843, 0.],RGBColor[0.567426, 0.32317, 0.729831]}[[#1]],
Blend[{RGBColor[0.81, 0.225, 0.225],RGBColor[0.855, 0.45, 0.1215],RGBColor[0.9, 0.675, 0.],RGBColor[0.495, 0.63, 0.],RGBColor[0., 0.63, 0.63],RGBColor[0.225, 0.45, 0.9],RGBColor[0.45, 0.315, 0.9],RGBColor[0.558, 0.252, 0.63],RGBColor[0.675, 0.252, 0.45],RGBColor[0.81, 0.225, 0.225]},
FractionalPart[(4+#1-1)/GoldenRatio]]],RGBColor]&,
"{\"Indexed\", \"VividColor\"}"},
{{"BlueRedSplit","blue-red split",{}},
{"Gradients"},1,{0,1},
{RGBColor[0.163302, 0.119982, 0.79353],RGBColor[0.254221, 0.313173, 0.892833],RGBColor[0.407119, 0.543513, 0.938275],RGBColor[0.572715, 0.73338, 0.95065],RGBColor[0.720374, 0.855234, 0.928635],RGBColor[0.831017, 0.903518, 0.868326],GrayLevel[1],RGBColor[0.894452, 0.880139, 0.77279],RGBColor[0.907999, 0.789417, 0.652903],RGBColor[0.874505, 0.639254, 0.522424],RGBColor[0.79915, 0.446142, 0.391971],RGBColor[0.685695, 0.242449, 0.268261],RGBColor[0.534081, 0.0853132, 0.16669]},""}};
End[];
...
def:"Plot"|"ListPlot"|"ListLinePlot"|"ListStepPlot"|"PolarPlot"|
...
"TradingChart"|"NumberLinePlot"|"TimelinePlot"|"WordCloud"]:=
...
Themes`SetWeight[
{AxesStyle->Directive[AbsoluteThickness[1],monoColor,FontSize->14],
FrameStyle->Directive[AbsoluteThickness[1],monoColor,FontSize->14],
...
Themes`SetWeight[{LabelStyle->Directive[monoColor,FontSize->12]},
Themes`$SizeWeight];
...
Themes`SetWeight[
{"DefaultPlotStyle"->Directive[AbsolutePointSize[4],AbsoluteThickness[1.5]],
"DefaultThickness"->AbsoluteThickness[1.5],
...
"DefaultPlotStyle"->Directive[AbsolutePointSize[4],AbsoluteThickness[1]],
MeshStyle->Directive[monoColor,AbsoluteThickness[1]],
"DefaultBoundaryStyle"->Directive[monoColor]},
$LineThicknessWeight];
...
$ThemeColorIndexed=0;
$ThemeColorDensity="BlueRedSplit";(*Thermometer for density*)
$ThemeColorArrayPlot={Black,White};(*Grayscale for Array*)
$ThemeColorDensity3D="BlueRedSplit";(*Thermometer for density*)
